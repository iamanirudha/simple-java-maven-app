        ...
        stage('Build') {
            steps {
                script {
                    ...
                    jf 'mvn-config   --repo-deploy-releases res-libs-release --repo-resolve-releases res-libs-release --repo-deploy-snapshots res-libs-snapshot  --repo-resolve-snapshots res-libs-snapshot'
